...
def test_write_to_cell_held_by_another_raises(tmp_path, make_manager):
    mgr = make_manager
...
def test_editor_can_write_its_own_cell(tmp_path, make_manager):
    mgr = make_manager
...
def test_free_cell_and_no_participant_id_are_unenforced(tmp_path, make_manager):
    mgr = make_manager
    _make_session(mgr, tmp_path)
...
def test_check_cell_lock_gate(tmp_path, make_manager):
    mgr = make_manager
    mgr.presence_heartbeat("2026-04", "p2", name="Carla", color="#b")
...
def test_set_note_enforces_lock(tmp_path, make_manager):
    mgr = make_manager
    mgr.presence_heartbeat("2026-04", "p1", name="Daniel", color="#a")
    mgr.presence_heartbeat("2026-04", "p2", name="Carla", color="#b")
    mgr.presence_focus("2026-04", "p2", "HRB|odi")
...
def test_apply_worker_count_enforces_lock(tmp_path, make_manager):
    mgr = make_manager
    mgr.presence_heartbeat("2026-04", "p1", name="Daniel", color="#a")
    mgr.presence_heartbeat("2026-04", "p2", name="Carla", color="#b")
...
def test_apply_confirmed_enforces_lock(tmp_path, make_manager):
    mgr = make_manager
    _make_session(mgr, tmp_path)
    mgr.presence_heartbeat("2026-04", "p1", name="Daniel", color="#a")
    mgr.presence_heartbeat("2026-04", "p2", name="Carla", color="#b")
...
def test_clear_near_matches_enforces_lock(tmp_path, make_manager):
    mgr = make_manager
    mgr.presence_heartbeat("2026-04", "p1", name="Daniel", color="#a")
    mgr.presence_heartbeat("2026-04", "p2", name="Carla", color="#b")
    mgr.presence_focus("2026-04", "p2", "HRB|odi")
...
def test_apply_per_file_override_enforces_lock(tmp_path, make_manager):
    mgr = make_manager
    _make_session(mgr, tmp_path)
    mgr.presence_heartbeat("2026-04", "p1", name="Daniel", color="#a")
    mgr.presence_heartbeat("2026-04", "p2", name="Carla", color="#b")
...
def test_reconcile_worker_marks_enforces_lock(tmp_path, make_manager):
...
def test_scan_file_ocr_endpoint_409_when_locked_by_another(tmp_path, monkeypatch, make_pdf):
...
def test_scan_file_ocr_endpoint_allows_editor_and_legacy(tmp_path, monkeypatch, make_pdf):
...
def test_scan_file_ocr_excludes_concurrent_batch_scan(tmp_path, monkeypatch, make_pdf):
...
def test_scan_file_ocr_releases_batch_handle_when_dispatch_fails(tmp_path, monkeypatch, make_pdf):
...
def test_scan_file_ocr_cancel_stops_the_run_and_frees_the_slot(tmp_path, monkeypatch, make_pdf):
...
def test_scan_file_ocr_merge_time_lock_recheck_blocks_stale_merge(tmp_path, monkeypatch, make_pdf):
...
def test_scan_file_ocr_merge_time_lock_recheck_allows_editor(tmp_path, monkeypatch, make_pdf):
